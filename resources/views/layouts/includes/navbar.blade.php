    ...
    <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                ...
                <div class="dropdown-list-content dropdown-list-message">
                    <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
                            ...
                            <img alt="image" src="{{ asset('static/assets/img/users/user-2.png') }}"
                                class="rounded-circle">
                            ...
                            <img alt="image" src="{{ asset('static/assets/img/users/user-5.png') }}"
                                class="rounded-circle">
                            ...
                            <img alt="image" src="{{ asset('static/assets/img/users/user-4.png') }}"
                                class="rounded-circle">
                            ...
                            <img alt="image" src="{{ asset('static/assets/img/users/user-3.png') }}"
                                class="rounded-circle">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                    src="{{ asset('static/assets/img/user.png') }}" class="user-img-radious-style"> <span
